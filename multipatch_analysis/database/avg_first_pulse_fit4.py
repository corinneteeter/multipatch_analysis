...
__all__ = ['avg_first_pulse_fit_table4', 'AvgFirstPulseFit4']


AvgFirstPulseFit4 = make_table(
    name='avg_first_pulse_fit4',
...
Pair.avg_first_pulse_fit4 = relationship(AvgFirstPulseFit4, back_populates="pair", cascade="delete", single_parent=True, uselist=False)
AvgFirstPulseFit4.pair = relationship(Pair, back_populates="avg_first_pulse_fit4", single_parent=True)

avg_first_pulse_fit_table4 = TableGroup([AvgFirstPulseFit4])
