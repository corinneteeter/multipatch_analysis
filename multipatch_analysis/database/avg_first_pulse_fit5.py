...
__all__ = ['avg_first_pulse_fit_table5', 'AvgFirstPulseFit5']


AvgFirstPulseFit5 = make_table(
...
Pair.avg_first_pulse_fit5 = relationship(AvgFirstPulseFit5, back_populates="pair", cascade="delete", single_parent=True, uselist=False)
AvgFirstPulseFit5.pair = relationship(Pair, back_populates="avg_first_pulse_fit5", single_parent=True)

avg_first_pulse_fit_table5 = TableGroup([AvgFirstPulseFit5])
